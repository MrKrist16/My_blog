        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="basicExampleNav">
            <ul class="navbar-nav mr-auto smooth-scroll">
              <li class="nav-item">
                <a href="/programming" class="nav-link waves-effect waves-light">Programming</a>
              </li>
              <li class="nav-item">
                <a href="/music" class="nav-link waves-effect waves-light">Music</a>
              </li>
              <li class="nav-item">
                <a href="/self_development" class="nav-link waves-effect waves-light">Self Development</a>
              </li>
              <li class="nav-item">
                <a href="/about_me" class="nav-link waves-effect waves-light">Contact with me</a>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div class="container-fluid d-flex align-items-center justify-content-center h-100">
            <div class="row d-flex justify-content-center text-center">
              <div class="col-md-10">
                ...
                <hr class="hr-light">
                <h4 class="white-text my-4">Th</h4>
        ...
        <div class="row">
          <div class="col-md-12 py-6">
            <div class="mb-5 flex-center">
              <a href="https://www.instagram.com/sergii_kirnosov/">
